package com.cly.eee.drawerlayout.drawerlayout1;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_drawellayout1);
        ...
        myAdapter = new MyAdapter<Item>(menuLists,R.layout.item_list_drawellayout1) {
            @Override
