package com.cly.eee.alertdialog;
...
public class MainActivityAlertDialog1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_alert_dialog1);
        mContext = MainActivityAlertDialog1.this;
        ...
        //加载自定义的那个View,同时设置下
        final LayoutInflater inflater = MainActivityAlertDialog1.this.getLayoutInflater();
